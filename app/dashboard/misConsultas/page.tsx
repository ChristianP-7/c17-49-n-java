...
export default function misConsultas() {
  ...
  const mostrarPopup = (nuevoMensaje: string) => {
      ...
      <div className="items-center justify-center md:mx-auto mt-10 md:mt-0 space-y-10 md:w-full max-w-[340px] md:max-w-[900px] xl:max-w-[1250px] 2xl:max-w-[1930px] md:mr-6 md:space-y-6 mb-4 md:mb-0 select-none">
        <section className="container md:px-4 mx-auto">
          ...
          <ConsultasPendientes
            funcionProp={() =>
              mostrarPopup(
                "¿Estás seguro de que deseas cancelar esta cita médica? Al hacerlo, deberás programar una nueva cita."
              )
            }
          />
        </section>
        <section className="container md:px-4 mx-auto ">
          ...
          <HistorialConsultas
            funcionProp={() =>
              mostrarPopup(
                "¿Estás seguro que deseas eliminar del historial esta consulta médica? Esta acción no se puede deshacer."
              )
            }
          />
        </section>
